...
describe('shapes', () => {
  ...
  describe('logoCircleTest', () => {
    it('should return true if the returned string contains M and z', () => {
      const newCircle = new Circle()
      // console.log(newCircle.shapePath);
      expect(newCircle.shapePath).toEqual(expect.stringContaining('M' && 'z'))
    })
  })
  ...
  describe('logoTriangleTest', () => {
    it('should return true if the returned string contains M and z', () => {
      ...
      expect(newTriangle.shapePath).toEqual(expect.stringContaining('M' && 'z'))
    })
  })
  ...
  describe('logoSquareTest', () => {
    it('should return true if the returned string contains M and z', () => {
      ...
      expect(newSquare.shapePath).toEqual(expect.stringContaining('M' && 'z'))
    })
  })
// testing that the rectangle class returns a path command containing 'M' & 'z'
  describe('logoRectangleTest', () => {
    it('should return true if the returned string contains M and z', () => {
      ...
      expect(newRectangle.shapePath).toEqual(expect.stringContaining('M' && 'z'))
    })
  })
})